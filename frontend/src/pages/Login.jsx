...
function Login() {
  ...
  return (
    <div className="flex-center" style={{ minHeight: '80vh' }}>
      ...
      >
        <h2 className="text-gradient" style={{ textAlign: 'center', marginBottom: '32px', fontSize: '32px' }}>Welcome Back</h2>
        ...
        <div style={{ display: 'flex', alignItems: 'center', margin: '24px 0' }}>
          ...
          <span style={{ padding: '0 16px', color: 'var(--text-secondary)', fontSize: '13px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.05em' }}>or sign in with email</span>
          <div style={{ flex: 1, height: '1px', backgroundColor: 'var(--border-color)' }}></div>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '32px', fontSize: '14px' }}>
          ...
          <Link to="/signup" style={{ color: 'var(--primary-color)', fontWeight: '600' }}>Create one here</Link>
        </div>
      </motion.div>
    </div>
  );
